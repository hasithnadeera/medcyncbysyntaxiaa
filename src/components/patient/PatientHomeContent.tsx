...
const medicalRecords = [
  { id: 1, date: "March 15, 2025", doctor: "Dr. Emily Johnson", diagnosis: "Seasonal allergies", notes: "Prescribed antihistamines for 2 weeks" },
  { id: 2, date: "January 7, 2025", doctor: "Dr. Michael Smith", diagnosis: "Annual checkup", notes: "All vitals normal, recommended diet adjustments" },
];

const prescriptions = [
  { id: 1, name: "Loratadine", dosage: "10mg", frequency: "Once daily", duration: "2 weeks" },
  { id: 2, name: "Amlodipine", dosage: "5mg", frequency: "Once daily", duration: "Ongoing" },
  { id: 3, name: "Metformin", dosage: "500mg", frequency: "Twice daily", duration: "Ongoing" },
];
      ...
      <Card className="md:col-span-2 lg:col-span-1">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <Button 
            variant="ghost" 
            size="sm"
            onClick={() => navigate("/patient-dashboard/medical-records")}
          >
            View all
          </Button>
        </CardHeader>
            ...
            <div className="space-y-4">
              {medicalRecords.map((record) => (
                <div key={record.id} className="flex flex-col space-y-1">
                  <p className="text-sm font-medium">{record.date} - {record.doctor}</p>
                  <p className="text-xs font-semibold">{record.diagnosis}</p>
          ...
          {prescriptions.length > 0 ? (
            <div className="space-y-4">
              {prescriptions.map((prescription) => (
                <div key={prescription.id} className="flex flex-col space-y-1">
